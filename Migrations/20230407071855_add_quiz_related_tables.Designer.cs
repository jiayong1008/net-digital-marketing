...
namespace DigitalMarketing2.Migrations
{
    ...
    [Migration("20230407071855_add_quiz_related_tables")]
    partial class add_quiz_related_tables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalMarketing2.Models.QuizQuestion", b =>
                {
                    ...
                    b.HasOne("DigitalMarketing2.Models.Module", "Lesson")
                        .WithMany()
